...
const MAX = process.argv[2] ? parseInt(process.argv[2]) : 10000;
const OUTPUT_FILE = resolvePath("./results", `test_${MAX}.csv`);
...
const init = (id, parsedFile, index) => {
	...
	const QUERY = `SELECT DISTINCT super_genre from music_test;`;
